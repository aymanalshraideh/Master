...
<div class="card" style="width: 18rem; margin:2% 2%">
  <img class="card-img-top" src="{{asset($item->image1)}}" alt="Card image cap" >
  <div class="card-body">
    <h5 class="card-title">{{$item->car_model}}</h5>
    <p class="card-text">{{$item->car_description}}</p>
    <a class="btn btn-primary" href="{{route('singleCar',['id'=>$item->id])}}">Book Now</a>
